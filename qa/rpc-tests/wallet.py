...
#   c) node1 mines 32 blocks, so now node 0 has 500000PANAM, node 1 has 4250PANAM, node2 has none.
#   d) node0 sends 601 PANAM to node2, in two transactions (301 PANAM, then 300 PANAM).
