...
Panam now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<panam_address\> \<monthly_payment_panam\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ PANAM, _12_ times over the course of a year totaling _24000_ PANAM.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<panam_address\> \<monthly_payment_panam\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` PANAM.
 ...
 * vote-many          - Vote on a Panam initiative
 * vote-alias         - Vote on a Panam initiative
 * vote               - Vote on a Panam initiative/budget
