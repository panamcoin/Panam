...
In order to support loading of multiple wallets in panam-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is panam.cpp.
...
Changes to panam.cpp
----------------------
panam.cpp is the entry point into panam-qt, and as such, will require some minor modifications to provide hooks for
