...
Intro
-----
Panam (PANAM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Panam utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run panam-qt.exe.

Panam Core is the original Panam client and it builds the backbone of the network.
However, it downloads and stores the entire history of Panam transactions;
