Contributing to Panam Core
==================================

The Panam Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Panam Core project, and is not to be
confused with overall Panam Network Protocol consensus changes.

Whether a pull request is merged into Panam Core rests with the project merge
...
Patches that change Panam consensus rules are considerably more involved than
...
Where a patch set proposes to change the Panam consensus, it must have been
...
The project leader is the release manager for each Panam Core release.
