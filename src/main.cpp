...
#if defined(NDEBUG)
#error "Panam cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in upanam) are considered zero fee (for relaying and mining)
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // PANAM: We use certain sporks during IBD, so check to see if they are
