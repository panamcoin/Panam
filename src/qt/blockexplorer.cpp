...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::PANAM, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (panam.conf).");
            QMessageBox::warning(this, "Panam Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#14369a; bgcolor:#fafafa;}\n a, span { font-family: monospace; }\n span.addr {color:#14369a; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #fafafa;}\n td.d0 {font-weight: bold; color:#14369a;}\n h2, h3 { white-space:nowrap; color:#14369a;}\n a { color:#337ab7; text-decoration:none; }\n a.nav {color:#337ab7;}\n";
