...
/** Utility functions used by the Panam Qt UI.
 */
namespace GUIUtil
{
...
// Render PANAM addresses in monospace font
...
// Parse "panam:" URI into recipient object, return true on successful parsing
