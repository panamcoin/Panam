...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Panam features */
        {"panam", "masternode", &masternode, true, true, false},
        {"panam", "listmasternodes", &listmasternodes, true, true, false},
        {"panam", "getmasternodecount", &getmasternodecount, true, true, false},
        {"panam", "masternodeconnect", &masternodeconnect, true, true, false},
        {"panam", "masternodecurrent", &masternodecurrent, true, true, false},
        {"panam", "masternodedebug", &masternodedebug, true, true, false},
        {"panam", "startmasternode", &startmasternode, true, true, false},
        {"panam", "createmasternodekey", &createmasternodekey, true, true, false},
        {"panam", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"panam", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"panam", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"panam", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"panam", "getmasternodescores", &getmasternodescores, true, true, false},
        {"panam", "mnbudget", &mnbudget, true, true, false},
        {"panam", "preparebudget", &preparebudget, true, true, false},
        {"panam", "submitbudget", &submitbudget, true, true, false},
        {"panam", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"panam", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"panam", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"panam", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"panam", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"panam", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"panam", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"panam", "checkbudgets", &checkbudgets, true, true, false},
        {"panam", "mnsync", &mnsync, true, true, false},
        {"panam", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> panam-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:45789/\n";
}
