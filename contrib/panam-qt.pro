...
RESOURCES += src/qt/panam.qrc src/qt/panam_locale.qrc

TRANSLATIONS += src/qt/locale/panam_bg.ts \
                src/qt/locale/panam_de.ts \
                src/qt/locale/panam_en.ts \
                src/qt/locale/panam_es.ts \
                src/qt/locale/panam_fi.ts \
                src/qt/locale/panam_fr.ts \
                src/qt/locale/panam_it.ts \
                src/qt/locale/panam_ja.ts \
                src/qt/locale/panam_pl.ts \
                src/qt/locale/panam_pt.ts \
                src/qt/locale/panam_ru.ts \
                src/qt/locale/panam_sk.ts \
                src/qt/locale/panam_sv.ts \
                src/qt/locale/panam_vi.ts \
                src/qt/locale/panam_zh_CN.ts \
                src/qt/locale/panam_zh_TW.ts
